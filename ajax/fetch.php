...
while($row = mysqli_fetch_array($result))
{
 ...
 $sub_array[] = '<button type="button" name="delete" class="btn btn-danger btn-xs delete" id="'.$row["id"].'">Delete</button><button type="button" name="delete" class="btn btn-info btn-xs" id="'.$row["id"].'">Edit</button>';
